...
```{r results-include-behavioral-plots, warning = FALSE, fig.cap="Mean accuracy and response times preceding and following error trials. Error bars represent 95% confidence intervals."}
