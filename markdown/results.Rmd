...
```{r results-include-behavioral-plots-robust, warning = FALSE, fig.cap="Robust approach to post-error effect. Mean accuracy and response times preceding and following error trials. Error bars represent 95% confidence intervals."}
combined_robust_plot_behavioral
```

```{r results-include-behavioral-plots-classic, warning = FALSE, fig.cap="Classical approach to post-error effect. Mean accuracy and response times following error trials vs. following correct trials. Error bars represent 95% confidence intervals."}
