...
initfun_robust <- function() {# all pars in stancode need init here
  list(
    ...
    b_ndt = rep(0.1, tmp_dat_robust$K_ndt)
  )
}
...
initfun_classic <- function() {# all pars in stancode need init here
  list(
    ...
    b_ndt = rep(0.1, tmp_dat_classic$K_ndt)
  )
}
```
...
```{r saving-ddm-robust}
save(fit_wiener_robust, file = paste0("./markdown/models/null_brms_wiener_fit_robust_", Sys.Date(), ".rda"),
     compress = "xz")
```
