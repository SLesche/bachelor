...
demo_output <- demo_data %>% 
  ...
  mutate(geschlecht_w_m_d_andere = ifelse( # dealing with "weiblich" / "männlich"
...
rio::export(demo_output, "./markdown/data/demo_output.rdata")
...
```{r lost trials}
trials_lost_filter <- nrow(rt_data) - nrow(final_data)
