...
error_data <- trial_data %>% 
  ...
  mutate(
    location = case_when(
      trial_type == "go" & lead(trial_type) == "nogo" & lead(acc) == 1 ~ "C-1",
      trial_type == "go" & lead(trial_type) == "nogo" & lead(acc) == 0 ~ "E-1",
      trial_type == "nogo" & acc == 1 ~ "C",
      trial_type == "nogo" & acc == 0 ~ "E",
      trial_type == "go" & lag(trial_type) == "nogo" & lag(acc) == 0 & !is.na(rt) ~ "E+1",
      trial_type == "go" & lag(trial_type) == "nogo" & lag(acc) == 1 & !is.na(rt) ~ "C+1",
      ...
      & !is.na(lag(rt)) & !is.na(rt) # dont want responses after no-responses in here
      & lead(trial_type) != "nogo" ~ "E+2",
      trial_type == "go" & lag(trial_type) == "go" 
      & lag(trial_type, 2) == "nogo" & lag(acc, 2) == 1
      & !is.na(lag(rt)) & !is.na(rt)
