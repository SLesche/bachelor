...
$$
\operatorname{rt} = \beta_{1}(\operatorname{rsi}_{\operatorname{long}}) + \beta_{2}(\operatorname{rsi}_{\operatorname{short}}) + \beta_{3}(\operatorname{error\_factor}_{\operatorname{post\_error}}) + \beta_{4}(\operatorname{stimulus}_{\operatorname{Y}}) + \beta_{5}(\operatorname{rsi}_{\operatorname{short}} \times \operatorname{error\_factor}_{\operatorname{post\_error}}) + \beta_{6}(\operatorname{rsi}_{\operatorname{short}} \times \operatorname{stimulus}_{\operatorname{Y}}) + \beta_{7}(\operatorname{error\_factor}_{\operatorname{post\_error}} \times \operatorname{stimulus}_{\operatorname{Y}}) + \beta_{8}(\operatorname{rsi}_{\operatorname{short}} \times \operatorname{error\_factor}_{\operatorname{post\_error}} \times \operatorname{stimulus}_{\operatorname{Y}}) + \epsilon
$$
