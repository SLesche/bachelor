...
We will conduct main analyses using the robust definition of PES to account for global shifts in performance^[We conducted all behavioral and DDM analysis with the classical measure of PES aswell [@dutilh2012how]. Results did not differ significantly, see Appendix //REPLACE// for Detail]. The robust approach selects only trials preceding and following errors to ensure that post-error trials and pre-error trials originate from the same place in the dataset.
