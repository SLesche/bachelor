...
$$\mu_{\alpha} \sim Gamma(10, 5)$$
$$\sigma_{\alpha} \sim Gamma(2, 4)$$
$$\mu_{\tau} \sim Gamma(1, 5)$$
$$\sigma_{\tau} \sim Gamma(2, 4)$$
$$\mu_{\beta} \sim Beta(4, 4)$$
