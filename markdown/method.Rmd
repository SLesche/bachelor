...
## Behavioral Analysis
Only errors in NoGo trials were considered _error trials_ relevant for PES analysis. PES was defined using the traditional approach [@dutilh2012how; @pfister2022] comparing mean reaction times in Go trials following an _error trial_ to mean reaction times following a correct response to a NoGo trial. Effects of RSI condition and accuracy of the previous NoGo trial were then examined using a 2x2 ANOVA. Post-error accuracy (PEA) was examined in a similar manner, comparing mean accuracy following a correct NoGo trial to mean accuracy of trials following an _error trial_.
