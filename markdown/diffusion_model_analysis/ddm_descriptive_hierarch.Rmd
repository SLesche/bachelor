...
combined_robust_plot <- ggarrange(drift_robust_plot, bs_robust_plot, ndt_robust_plot, bias_robust_plot, labels = c("v", "a", "Ter", "z"))
```
...
combined_classic_plot <- ggarrange(drift_classic_plot, bs_classic_plot, ndt_classic_plot, bias_classic_plot, labels = c("v", "a", "Ter", "z"))
...
combined_speed_plot <- ggarrange(drift_speed_plot, bs_speed_plot, ndt_speed_plot, bias_speed_plot, labels = c("v", "a", "Ter", "z"))
```
