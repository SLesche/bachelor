...
combined_robust_plot <- grid.arrange(drift_robust_plot, bs_robust_plot, ndt_robust_plot, bias_robust_plot)
```
...
combined_classic_plot <- grid.arrange(drift_classic_plot, bs_classic_plot, ndt_classic_plot, bias_classic_plot)
```
...
combined_speed_plot <- grid.arrange(drift_speed_plot, bs_speed_plot, ndt_speed_plot, bias_speed_plot)
```
