...
# Investigate cluster
fit <- rio::import("./markdown/diffusion_model_runs/cluster/output/location_standard_bias_final_2023-03-07.rda")
pred <- rio::import("./markdown/diffusion_model_runs/cluster/output/prediction_location_base.rdata")
data <- fit$data
```
...
compare_all_conditions(combined_data)

list_plots[3]
grid.arrange(grobs = list_plots[1:12], ncol = 4)
grid.arrange(grobs = list_plots[13:24], ncol = 4)
grid.arrange(grobs = list_plots[1:24], ncol = 4)
