...
# Investigate cluster
fit <- rio::import("./markdown/diffusion_model_runs/cluster/output/location_rsi_bias_2023-03-09.rda")
pred <- rio::import("./markdown/models/prediction_location_base.rdata")
data <- fit$data
```
...
grid.arrange(grobs = visual_fit[1:24], ncol = 4)
