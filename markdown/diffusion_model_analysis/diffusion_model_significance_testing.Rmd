...
evidence_posterior <- posterior_robust %>% 
  mutate(
    short_pre_error_evidence_X = calculate_evidence(
      `b_bs_rsishort:error_factorpre_error`,
      `b_bias_rsishort:previous_stimulusY:error_factorpre_error`
    ),
    short_pre_error_evidence_Y = calculate_evidence(
      `b_bs_rsishort:error_factorpre_error`,
      `b_bias_rsishort:previous_stimulusX:error_factorpre_error`
    ),
    short_post_error_evidence_X = calculate_evidence(
      `b_bs_rsishort:error_factorpost_error`,
      `b_bias_rsishort:previous_stimulusY:error_factorpost_error`
    ),
    short_post_error_evidence_Y = calculate_evidence(
      `b_bs_rsishort:error_factorpost_error`,
      `b_bias_rsishort:previous_stimulusX:error_factorpost_error`
    ),
    long_pre_error_evidence_X = calculate_evidence(
      `b_bs_rsilong:error_factorpre_error`,
      `b_bias_rsilong:previous_stimulusY:error_factorpre_error`
    ),
    long_pre_error_evidence_Y = calculate_evidence(
      `b_bs_rsilong:error_factorpre_error`,
      `b_bias_rsilong:previous_stimulusX:error_factorpre_error`
    ),
    long_post_error_evidence_X = calculate_evidence(
      `b_bs_rsilong:error_factorpost_error`,
      `b_bias_rsilong:previous_stimulusY:error_factorpost_error`
    ),
    long_post_error_evidence_Y = calculate_evidence(
      `b_bs_rsilong:error_factorpost_error`,
      `b_bias_rsilong:previous_stimulusX:error_factorpost_error`
    )
  )
...
cohens_d_evidence_accumulated_long <- cohen.d(
  c(evidence_posterior$long_pre_error_evidence_Y, evidence_posterior$long_pre_error_evidence_X),
  c(evidence_posterior$long_post_error_evidence_Y, evidence_posterior$long_post_error_evidence_X)
)
