...
```{r descriptive-analysis-block comparison, include = FALSE, cache = TRUE, dependson='data', eval = FALSE}
data %>% 
  group_by(rsi, block) %>% 
...
```{r descriptive-analysis-visualization, include = FALSE, cache = TRUE, dependson='data'}
data %>% 
...
```{r descriptive-analysis-overview-table}
...
data %>% 
  ...
  apa_table(., caption = "Descriptive Values", note = "Replace this with meaning")
```
