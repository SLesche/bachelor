...
The short deadline which lead to model issues in the short RSI condition may lead to another potential explanation for the lower boundary separation in post-error trials. Participants realize that they sometimes fail to respond, especially following error trials. This leads them to adapt their response behavior following an error trial in order to increase their response speed. Errors may create circumstances post-error, where speed carries a higher relative importance. Emphasis on response speed has been shown to lead to a decrease in boundary separation [@voss2004; @ratcliff1998].

In our data we did not observe a decrease in response times following errors predicted by _post-error recklessness_ but found a small PES-effect even in the long RSI condition. This is due to the decreased drift rate following error trials. Errors seem to induce maladaptive decreases in drift rate post-error even in the long RSI conditions. In summary, participants display some signs of _post-error recklessness_, reflected in decreased boundary separation. However, simultaneous decreases in drift rate prevent overall post-error speeding.
