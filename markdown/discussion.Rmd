...
Our behavioral results support the maladaptive account that errors lead to more impactful accuracy decreases in the short RSI condition than in the long RSI condition. This does indicate more severe attentional deficits, but response times and accuracy alone do not allow further dissection of the cognitive processes underlying these differences. To further analyze the cognitive processes underlying post-error behavior we attempted to fit a Bayesian hierarchical DDM to data in both RSI conditions.
