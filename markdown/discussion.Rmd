...
Explaining this:
in terms of model problems: only sampling low bs trials (in long rsi not a problem)
...
A strength of this study is the ability to discern pre-correct from pre-error trials, this allows us to find effects even prior to error commission. **add this to results**
