...
Our behavioral findings show that errors lead to greater accuracy reduction in the short RSI condition compared to the long RSI condition, which aligns with earlier studies [@dudschig2009; @jentzsch2009; @buzzel2017]. Post-error performance was compromised particularly in the case of a short RSI, as evidenced by both increased response time and reduced accuracy. The long RSI condition exhibited less pronounced negative effects on both response time and accuracy. Even in the long RSI condition, reductions in accuracy post-error remained, indicating some lingering influence of maladaptive processes [@dudschig2009]. Critically, the magnitude of these decreases was less pronounced compared to the short RSI condition. This stronger impact of errors in the short RSI condition on accuracy in the following trials indicates that maladaptive processes influence response behavior especially in the short RSI condition.

The number of omissions following error trials provides additional evidence for an increased role of maladaptive processes at short RSI. In the short condition, participants failed to respond at all in `r 100*proportion_omissions_location %>% filter(rsi == 0.2, location == "E+1") %>% pull(freq)`% of trials following an error compared to an average omission rate of `r 100*proportion_omissions_location %>% filter(rsi == 0.2, location != "E+1") %>% pull(freq) %>% mean(., na.rm = TRUE)`% in all other trials. In the long condition, this rate was reduced to `r 100*proportion_omissions_location %>% filter(rsi == 1, location == "E+1") %>% pull(freq)`%. The number of omissions may be accounted for by slower overall response times due to _error-monitoring processes_ taking up some amount of central cognitive resources [@dudschig2009]. This leads to a high rate of non-responses before the response deadline as the evidence accumulation process did not reach on of the response boundaries. 
