...
save(fit_wiener_classic, file = paste0("./markdown/models/classic_hierarch_rsi_err-id_rsi_", Sys.Date(), ".rda"),
     compress = "xz")
```
...
```{r saving-ddm-robust}
save(fit_wiener_robust, file = paste0("./markdown/models/robust_hierarch_rsi_err-rsi_id_", Sys.Date(), ".rda"),
     compress = "xz")
```
