...
## ----saving-ddm-classic-----------------------------------------------------------------------
save(fit_wiener, file = paste0("./bachelor/models/only_drift.rda"),
     compress = "xz")

fit_wiener <- add_criterion(fit_wiener, criterion = "loo")

save(fit_wiener, file = paste0("./bachelor/models/model_comp/only_drift.rda"),
     compress = "xz")
...
save(pred, file = "./bachelor/predictions/pred_only_drift.rda")
