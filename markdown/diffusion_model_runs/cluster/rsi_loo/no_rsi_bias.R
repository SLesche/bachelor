...
## ----saving-ddm-classic-----------------------------------------------------------------------
save(fit_wiener, file = paste0("./bachelor/models/no_rsi_bias.rda"),
     compress = "xz")

fit_wiener <- add_criterion(fit_wiener, criterion = "loo")

save(fit_wiener, file = paste0("./bachelor/models/model_comp/no_rsi_bias.rda"),
     compress = "xz")
...
save(pred, file = "./bachelor/predictions/pred_no_rsi_bias.rda")
