...
library(dplyr)
## ----data-------------------------------------------------------------------------------------
data <- rio::import("./bachelor/data/diffusion_data_classic.rdata")
...
## ----saving-ddm-classic-----------------------------------------------------------------------
save(fit_wiener, file = paste0("./bachelor/models/base_model_classic.rda"),
     compress = "xz")

# fit_wiener <- add_criterion(fit_wiener, criterion = "loo")
# 
# save(fit_wiener, file = paste0("./bachelor/models/model_comp/base_model_classic.rda"),
#      compress = "xz")
...
save(pred, file = "./bachelor/predictions/pred_base_model_classic.rda")