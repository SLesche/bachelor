...
prior <- c(
  ...
  # Non-decision time
  set_prior("uniform(0, 0.15)", class = "b", dpar = "ndt", lb = 0, ub = 0.15),
  
  # bias
  set_prior("uniform(0, 1)", class = "b", dpar = "bias", lb = 0, ub = 1),
...
## ----saving-ddm-classic-----------------------------------------------------------------------
save(fit_wiener_location, file = paste0("./bachelor/models/full_effect_location_bias_", Sys.Date(), ".rda"),
     compress = "xz")
