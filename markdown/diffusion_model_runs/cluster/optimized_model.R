...
formula <- bf(
  ...
  bias ~ 0 + previous_stimulus:error_factor
)
...
## ----saving-ddm-classic-----------------------------------------------------------------------
save(fit_wiener, file = paste0("./bachelor/models/optimized_model.rda"),
     compress = "xz")

fit_wiener <- add_criterion(fit_wiener, criterion = "loo")

save(fit_wiener, file = paste0("./bachelor/models/model_comp/optimized_model.rda"),
     compress = "xz")
...
save(pred, file = "./bachelor/predictions/pred_optimized_model.rda")