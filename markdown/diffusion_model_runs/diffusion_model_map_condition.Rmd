...
save(fit_wiener_classic, file = paste0("./markdown/models/classic_map_condition_", Sys.Date(), ".rda"),
     compress = "xz")
```
...
```{r saving-ddm-robust}
save(fit_wiener_robust, file = paste0("./markdown/models/robust_map_condition_", Sys.Date(), ".rda"),
     compress = "xz")
```
