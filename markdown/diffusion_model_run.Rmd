...
formula <- bf(
  ...
  rt | dec(decision) ~ 0 + rsi:error_factor:stimulus + (0 + rsi:stimulus|id),
...
initfun_robust <- function() {# all pars in stancode need init here
  list(
    ...
    b_ndt = rep(0.1, tmp_dat_robust$K_ndt), # rep for each dim in ndt
...
initfun_classic <- function() {# all pars in stancode need init here
  list(
    ...
    b_ndt = rep(0.1, tmp_dat_classic$K_ndt), # rep dim times
