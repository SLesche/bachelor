...
<!-- Introduction -->
```{r child = "markdown/introduction.Rmd", eval = piecewise_load[1]}
```

<!-- Method -->
```{r child = "markdown/method.Rmd", eval = piecewise_load[2]}
```
```{r}
gc()
```
...
<!-- Results -->
```{r child = "markdown/results.Rmd", eval = piecewise_load[3]}
```
```{r}
gc()
```
...
<!-- Discussion -->
```{r child = "markdown/discussion.Rmd", eval = piecewise_load[4]}
```
```{r}
gc()
```
...
```{r child = "markdown/appendix.Rmd", eval = piecewise_load[5]}
```
