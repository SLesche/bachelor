---
title             : "Effects of the Response-Stimulus-Interval on the Nature of Cognitive Processes Underlying Post-Error Slowing – A Diffusion Model Account"
...
add_prefix_chunk_labels <- function(file){
  if (file.exists(file)){
    ...
    # write to new file
    write_lines(replaced_lables, file = file)
  } 
  else {
    print(file)
...
files_to_alter <- rmd_files[-which(rmd_files == "master.Rmd")]
