...
```{r significance-testing-condition}
data %>% 
...
```{r significance-testing-rsi-error-code}
...
```{r significance-testing-emmeans}
...
```{r significance-testing-papaja-example}
papaja::apa_print(
  aov_rt_rsi_error_classic
)
```

```{r significance-testing-linear-models, eval = FALSE, inclue = FALSE}
...
```{r significance-testing-exporting}
