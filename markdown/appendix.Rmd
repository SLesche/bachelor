...
```{r appendix-descriptive-analysis-overview-table, results = 'asis'}
...
```{r appendix-descriptive-location-plot-rt, fig.cap = 'Mean response time (ms) depending on RSI and location'}
descriptive_location_plot_rt
```

```{r appendix-descriptive-location-plot-acc, fig.cap = 'Mean trial accuracy depending on RSI and location'}
