...
save(fit_wiener_nogo_null, file = paste0("./markdown/models/null_brms_wiener_fit_nogo_", Sys.Date(), ".rda"),
     compress = "xz")
```
...
```{r saving-ddm-classic}
save(fit_wiener_nogo_rsi, file = paste0("./markdown/models/rsi_brms_wiener_fit_nogo_", Sys.Date(), ".rda"),
     compress = "xz")
```
